# X12 860 - Purchase Order Change Request (Version 004010)
# SKELETON - Requires completion with full segment definitions
# Functional Group: PC
# Reference: X12 004010 Standard - Transaction Set 860
...
syntax = {
    ...
    'functionalgroup': 'PC',  # Purchase Order Change Request
}

# TODO: Complete this structure with full segment definitions
# Required segments to add: CUR, REF, PER, TAX, FOB, CTP, SAC, ITD, DIS, DTM, N1, POC, CTT
...
{ID: 'ST', MIN: 1, MAX: 1, LEVEL: [
    # Beginning Segment for Purchase Order Change - mandatory
    {ID: 'BCH', MIN: 1, MAX: 1},
...
# COMPLETION NOTES:
# 1. Consult X12 004010 Implementation Guide for 860
